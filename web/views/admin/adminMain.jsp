...
<%
	...
	int camCount=(int)request.getAttribute("camCount");
	List<Date> gdate=(List<Date>)request.getAttribute("gdate");
	List<Integer> gcount=(List<Integer>)request.getAttribute("gcount");
...
<body id="page-top">
 ...
 -->
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                총 차량 종류</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><%=cCount %>대</div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">총 제휴 캠핑장 수
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><%=camCount %>개</div>
                                                </div>
                                                <div class="col">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                답변 대기중인 QA</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><%=qcount %>개</div>
                                        </div>
                                        <div class="col-auto">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">회원 가입 Graph</h6>
                        ...
                        <div class="col-xl-4 col-lg-5">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">차량 대여 현황(총:<%=pie.get(0) %>)</h6>
                                    <div class="dropdown no-arrow">
                                        <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink"
                                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-4 text-center small">
                                        ...
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-success"></i> 사용가능한 차량 수
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-info"></i> 대여된 차량 수
                                        </span>
                                    </div>
                                </div>
                            </div>
    ...
    <!-- Page level plugins -->
    <script src="<%=request.getContextPath() %>/Resources/AdminTemplate/vendor/chart.js/Chart.min.js"></script>

    <!-- Page level custom scripts -->
   <%--  <script src="<%=request.getContextPath() %>/Resources/AdminTemplate/js/demo/chart-area-demo.js"></script>
    <script src="<%=request.getContextPath() %>/Resources/AdminTemplate/js/demo/chart-pie-demo.js"></script --%>>
...
/*파이그래프 */
	...
	var myPieChart = new Chart(ctx, {
	  type: 'doughnut',
	  data: {
	    labels: ["전체 차량 수", "대여된 차량 수"],
	    datasets: [{
	      data: [<%=pie.get(1)%>, <%=pie.get(2)%>],
