...
.submit-btn {
  ...
  padding: 10px;
    ...
    <div class="updatePassword-container">
		<form name="updatePwdFrm" action="<%=request.getContextPath()%>/member/searchPwdEndResult" method="post" >
					<input type="hidden" name="userId" value="<%=searchPwd.getUserId()%>">
					<center><h2>비밀번호 변경</h2></center>
